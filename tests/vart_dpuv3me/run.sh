...
${ROOT}/build/tests/vart_dpuv3me.exe  ${ROOT}/tests/app/models/v3me_ssd_mobilenet/dpu.xmodel ${ROOT}/tests/app/models/v3me_ssd_mobilenet/meta.json ${ROOT}/tests/dpuv3int8/models/commonImgLabelDir/imageDir/
