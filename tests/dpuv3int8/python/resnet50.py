...
os.environ["XLNX_VART_FIRMWARE"] = "/opt/xilinx/overlaybins/dpuv3int8"
...
def main():
    ...
    image = preprocess_one_image(SCRIPT_PATH + "/001.jpg", width, height, MEANS, SCALES, fixpos)
