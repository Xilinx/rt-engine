...
# {212: <bound method BasicCode.gen_fm_par_fm of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 232: <bound method BasicCode.gen_fm_ddr_fm of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 333: <bound method BasicCode.gen_any_par_any of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 332: <bound method BasicCode.gen_any_par_any of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 313: <bound method BasicCode.gen_any_par_any of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 312: <bound method BasicCode.gen_any_par_any of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 213: <bound method BasicCode.gen_any_par_any of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>, 233: <bound method BasicCode.gen_any_par_any of <SC.HwAbstraction.code_class.BasicCode object at 0x7f3851e5cc10>>}
####### input #######
...
##### IN input ddr TensorShapes(batch=4, width=224, height=224, channel=3) (0, 2453) ######
...
#### resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D OUTPUT SPLIT by h total 2 ####
#### ATT {'dependency_summary': [0, 0, 0, 0, 1, 1], 'dilation': [1, 1], 'kernel': [3, 3], 'pad': [0, 0, 0, 0], 'pad_mode': 'SAME', 'quant_in_signed': 1, 'quant_out_signed': 1, 'stride': [1, 1], 'kernel_width': 3, 'kernel_height': 3, 'kernel_1': TensorShapes(batch=0, width=3, height=3, channel=0), 'stride_width': 1, 'stride_height': 1, 'strides_1': TensorShapes(batch=0, width=1, height=1, channel=0), 'dilation_width': 1, 'dilation_height': 1, 'pad_left': 1, 'pad_right': 1, 'pad_top': 1, 'pad_bottom': 1, 'sync_type': 4}  #### 
##### IN resnet_v1_50/block3/unit_3/bottleneck_v1/conv1/Conv2D fm TensorShapes(batch=4, width=14, height=14, channel=256) (16, 0) ######
##### OUT resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D TensorShapes(batch=4, width=14, height=14, channel=256) (0) (0, 4021) Absolute 3 0x3ed4000 #####
## Start DDR-to_DDR SPLIT by h 0 ##
#### BARRIER CONV START MARKER #####
#### CONV (1,1, 3,3 1,1)) #### 
#### ATT {'dependency_summary': [0, 0, 0, 0, 1, 1], 'dilation': [1, 1], 'kernel': [3, 3], 'pad': [0, 0, 0, 0], 'pad_mode': 'SAME', 'quant_in_signed': 1, 'quant_out_signed': 1, 'stride': [1, 1], 'kernel_width': 3, 'kernel_height': 3, 'kernel_1': TensorShapes(batch=0, width=3, height=3, channel=0), 'stride_width': 1, 'stride_height': 1, 'strides_1': TensorShapes(batch=0, width=1, height=1, channel=0), 'dilation_width': 1, 'dilation_height': 1, 'pad_left': 1, 'pad_right': 1, 'pad_top': 1, 'pad_bottom': 15, 'sync_type': 4, '_iterations_': 2, '_iteration_': 0}  #### 
##### IN resnet_v1_50/block3/unit_3/bottleneck_v1/conv1/Conv2D (16, 0) TensorShapes(batch=4, width=14, height=10, channel=256)
#####  -> OUT resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D (8, 0) TensorShapes(batch=4, width=14, height=8, channel=256) #### 
CONVINIT 0000 0000 kernel_w 3 kernel_h 3 shift_cut 8 stride_w 1 stride_h 1 act_type 1 jump_write 16 jump_write_endl 224 jump_read 16 jump_read_endl 224 wgt_jump_read_endl 144 stride_out 1 channel_group_in 16 channel_group_out 16 channel_offset 0 prelu_shift_p 0
CONV 0001 0010 pad_left 1 pad_top 1 pad_right 1 pad_bottom 15 bank_id_in 23 bank_id_out 8 bank_addr_in 3856 bank_addr_out 0 bank_addr_weights 0 bank_addr_bias 2304 length 14 bank_addr_prelu 0 stride_offset_out 0 prelu_offset 0 bias_offset 0 valid_pixel_parallel 8 prelu_shift_n 0
#### BARRIER CONV STOP MARKER #####
#### outputs resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D for  start ######
#### BARRIER SAVE START MARKER #####
#### START 0-0 END 8-8 
####I resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D TensorShapes(batch=4, width=14, height=8, channel=256) 2 
####O resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D TensorShapes(batch=4, width=14, height=8, channel=256) 3 #####
SAVE 0100 0000 mode 0 bank_addr 0 bank_id 8 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 0
SAVE 0000 0000 mode 0 bank_addr 0 bank_id 9 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 14336
SAVE 0000 0000 mode 0 bank_addr 0 bank_id 10 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 28672
SAVE 0000 0000 mode 0 bank_addr 0 bank_id 11 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 43008
SAVE 0000 0000 mode 0 bank_addr 0 bank_id 12 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 57344
SAVE 0000 0000 mode 0 bank_addr 0 bank_id 13 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 71680
SAVE 0000 0000 mode 0 bank_addr 0 bank_id 14 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 86016
SAVE 0000 0100 mode 0 bank_addr 0 bank_id 15 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 100352
#### BARRIER SAVE STOP MARKER #####
#### outputs resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D for  end ######
## End DDR-to_DDR SPLIT by h 0 ##
## Start DDR-to_DDR SPLIT by h 1 ##
#### BARRIER CONV START MARKER #####
#### CONV (1,1, 3,3 1,0)) #### 
#### ATT {'dependency_summary': [0, 0, 0, 0, 1, 1], 'dilation': [1, 1], 'kernel': [3, 3], 'pad': [0, 0, 0, 0], 'pad_mode': 'SAME', 'quant_in_signed': 1, 'quant_out_signed': 1, 'stride': [1, 1], 'kernel_width': 3, 'kernel_height': 3, 'kernel_1': TensorShapes(batch=0, width=3, height=3, channel=0), 'stride_width': 1, 'stride_height': 1, 'strides_1': TensorShapes(batch=0, width=1, height=1, channel=0), 'dilation_width': 1, 'dilation_height': 1, 'pad_left': 1, 'pad_right': 1, 'pad_top': 0, 'pad_bottom': 1, 'sync_type': 4, '_iterations_': 2, '_iteration_': 1}  #### 
##### IN resnet_v1_50/block3/unit_3/bottleneck_v1/conv1/Conv2D (23, 0) TensorShapes(batch=4, width=14, height=5, channel=256)
#####  -> OUT resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D (8, 224) TensorShapes(batch=4, width=14, height=6, channel=256) #### 
CONVINIT 0000 0000 kernel_w 3 kernel_h 3 shift_cut 8 stride_w 1 stride_h 1 act_type 1 jump_write 16 jump_write_endl 224 jump_read 16 jump_read_endl 224 wgt_jump_read_endl 144 stride_out 1 channel_group_in 16 channel_group_out 16 channel_offset 0 prelu_shift_p 0
CONV 0010 0010 pad_left 1 pad_top 0 pad_right 1 pad_bottom 1 bank_id_in 23 bank_id_out 8 bank_addr_in 4080 bank_addr_out 224 bank_addr_weights 0 bank_addr_bias 2304 length 14 bank_addr_prelu 0 stride_offset_out 0 prelu_offset 0 bias_offset 0 valid_pixel_parallel 6 prelu_shift_n 0
#### BARRIER CONV STOP MARKER #####
#### outputs resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D for  start ######
#### BARRIER SAVE START MARKER #####
#### START 0-0 END 6-6 
####I resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D TensorShapes(batch=4, width=14, height=6, channel=256) 2 
####O resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D TensorShapes(batch=4, width=14, height=6, channel=256) 3 #####
SAVE 0100 0000 mode 0 bank_addr 224 bank_id 8 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 114688
SAVE 0000 0000 mode 0 bank_addr 224 bank_id 9 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 129024
SAVE 0000 0000 mode 0 bank_addr 224 bank_id 10 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 143360
SAVE 0000 0000 mode 0 bank_addr 224 bank_id 11 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 157696
SAVE 0000 0000 mode 0 bank_addr 224 bank_id 12 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 172032
SAVE 0000 0010 mode 0 bank_addr 224 bank_id 13 jump_write 256 jump_read 16 length 14 channel 256 reg_id 1 ddr_addr 186368
#### BARRIER SAVE STOP MARKER #####
#### outputs resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D for  end ######
## End DDR-to_DDR SPLIT by h 1 ##
####### resnet_v1_50/block3/unit_3/bottleneck_v1/conv2/Conv2D #######
