...
std::vector<vart::TensorBuffer*> init_tensor_buffer_with_addr(std::vector<uint64_t> data, std::vector<int> tensor_offset, std::vector<const xir::Tensor*> tensors, int batchSupport, unsigned runEngine=1);
